...
const translations: Record<string, { cs: string; en: string }> = {
  ...
  // The router's front panel (components/router-ports/*); the lan.* texts below it are shared.
  'ports.title': { cs: 'Porty routeru', en: 'Router ports' },
  'ports.in_use': { cs: '{n} z {m} portů zapojeno', en: '{n} of {m} ports in use' },
  'ports.unknown_n': { cs: '{n} neznámé', en: '{n} unknown' },
  'ports.group_lan': { cs: 'LAN – přepínač', en: 'LAN switch' },
  'ports.backup': { cs: 'záloha', en: 'backup' },
  'ports.no_internet': { cs: 'bez internetu', en: 'no internet' },
  'ports.as_of': { cs: 'stav před {ago}', en: 'state {ago} ago' },
  'ports.stale': {
    cs: 'Poslední hlášení z {time} – nejde o živý stav.',
    en: 'Last report at {time} – not the live state.',
  },
  'ports.medium': { cs: 'Médium (SFP/RJ45) agent nehlásí.', en: 'Medium (SFP/RJ45) not reported.' },
  'ports.duplex_full': { cs: 'plný', en: 'full' },
  'ports.duplex_half': { cs: 'poloviční duplex', en: 'half duplex' },
  'ports.row_cap': { cs: 'Port umí', en: 'Port can do' },
  'ports.row_partner': { cs: 'Protistrana nabídla', en: 'Partner offered' },
  'ports.row_clients': { cs: 'Zařízení za portem', en: 'Devices behind' },
  'ports.row_rate': { cs: 'Provoz, poslední minuta', en: 'Traffic, last minute' },
  'ports.since_boot': { cs: 'Od startu routeru', en: 'Since router boot' },
  'ports.row_flaps': { cs: 'Ztráty linky', en: 'Link losses' },
  'ports.row_errors': { cs: 'Chyby', en: 'Errors' },
  'ports.legend_in_use': { cs: 'kabel, za ním zařízení', en: 'cable, devices behind' },
  'ports.leds': { cs: 'kontrolky: linka · provoz', en: 'LEDs: link · traffic' },
  'ports.usb_devices': { cs: 'Na USB: {n}', en: 'On USB: {n}' },
  // The switch drawn port by port, shared with the panel above.
