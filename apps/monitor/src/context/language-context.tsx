...
const translations: Record<string, { cs: string; en: string }> = {
  ...
  'net.link_unknown_primary': {
    cs: 'Agent nehlásí WAN zařízení (verze před 0.1.3) - primární strana je neznámá.',
    en: 'The agent does not report the WAN device (before 0.1.3) - the primary side is unknown.',
  },
  'net.link_no_backup': { cs: 'Bez LTE zařízení.', en: 'No LTE device.' },
  'net.link_time_on_backup': { cs: 'Čas na záloze (30 dní)', en: 'Time on the backup (30 days)' },
  'net.link_never': { cs: 'nikdy', en: 'never' },
  'net.link_on_backup_now': { cs: 'Teď běží přes zálohu.', en: 'Running on the backup now.' },
  'net.link_periods': { cs: 'Období na záloze', en: 'Periods on the backup' },
  'net.link_since_before': { cs: 'před začátkem okna', en: 'before the window' },
  'net.link_still': { cs: 'dosud', en: 'still' },
  'net.link_period_label': { cs: 'Na LTE záloze', en: 'On the LTE backup' },
