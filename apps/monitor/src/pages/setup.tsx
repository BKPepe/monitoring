...
export function SetupPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setSuccess(
        installed
          ? t('setup.login_success', 'Přihlášení úspěšné! Přesměrovávám na dashboard...')
    ...
    >
      ...
      >
        ...
        <img
          ...
          style={{ width: '220px', maxWidth: '80%', display: 'block', margin: '0 auto 1.25rem' }}
        />
          ...
          >
            {loading
              ...
              : installed
                ...
                : t('setup.finish_install', 'Dokončit instalaci a přihlásit se')}
          </button>
        </form>
