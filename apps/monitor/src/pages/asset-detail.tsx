...
function buildGenericAsset(id: number): AssetDetail {
  ...
  if (id === 4) {
    return {
      ...
      name: 'Minecraft',
      kind: 'MINECRAFT',
      subtitle: 'MINECRAFT · mc.bloodkings.eu:25565',
      status: 'up',
      ...
      summary: 'Minecraft server BloodKings.eu na portu 25565. Sledován stav serveru, počet hráčů a odezva v čase.',
      summaryChips: [
        { label: 'Online (SLA 99.98 %)', variant: 'up' },
        { label: 'Hráči: 4 / 50', variant: 'info' },
        { label: 'Paper Spigot 1.20.4', variant: 'info' },
      ],
      info: [
        { label: 'Cílový hostitel', value: 'mc.bloodkings.eu:25565' },
        { label: 'Stav', value: 'Online (200 OK)' },
        { label: 'Odezva', value: '24 ms' },
        { label: 'Uptime (30 dní)', value: '99.98 %' },
      ],
      events: [
        { id: 1, title: 'Minecraft Ping OK', detail: 'Odezva 24 ms, spojení na port 25565 aktivní.', at: `Dnes ${new Date().toLocaleTimeString('cs-CZ', { hour: '2-digit', minute: '2-digit' })}`, severity: 'info', resolution: 'Info' }
      ],
      processes: [],
      related: [],
    };
