...
export function UserMenu({
  ...
  const isLoggedOut = name === 'Nepřihlášen';
  ...
  if (isLoggedOut) {
    return <Link to="/setup" title="Přihlásit se / Nastavit">{content}</Link>;
  }

  return <Link to="/users" title="Profil a uživatelé">{content}</Link>;
}
