...
CREATE TABLE IF NOT EXISTS `monitors` (
  ...
  -- On the public status page: 1/0 = the owner's choice, NULL = never chosen, which follows
  -- the type (vps, openwrt and agent_service stay off the public page, see bk_monitor_is_public).
